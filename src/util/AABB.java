...
public class AABB{
	...
	public int yb;
	public int zb;
	public boolean haveXYZ;
	public AABB(double x, double y, double z, double minX, double minY, double minZ, double maxX, double maxY, double maxZ, int xb, int yb, int zb){
		this(x, y, z, minX, minY, minZ, maxX, maxY, maxZ);
		this.xb = xb;
		this.yb = yb;
		this.zb = zb;
		haveXYZ = true;
	...
	public String toString(){
		return "[minX: " + getAbsMinX() + ", minY; " + getAbsMinY() + ", minZ: " + getAbsMinZ() + ", maxX: " + getAbsMaxX() + ", maxY; " + getAbsMaxY() + ", maxZ: " + getAbsMaxZ() + "]";
	}
}
